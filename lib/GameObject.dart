...
class GameObject {
  ...
  late Function animationCallback;
  ...
  GameObject(double inScreenWidth, double inScreenHeight, String inBaseFilename, int inWidth, int inHeight, int inNumFrames,
      int inFrameSkip, Function inAnimationCallback) {
